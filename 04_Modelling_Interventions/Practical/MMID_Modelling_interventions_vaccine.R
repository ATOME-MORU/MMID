  ...
  with(as.list(c(state, parameters)),
       {
         ...
         R0<-beta*gamma/((muo+nui)*(gamma+muo))
         ...
         dI <- -muo*I-nui*I+gamma*E
         dR <- -muo*R-omega*R+vaccinate*S+nui*I
...
lines(time,out[,"E"],type='l',col="orange1",lwd=3)
lines(time,out[,"I"],type='l',col="red2",lwd=3)
lines(time,out[,"R"],type='l',col="green3",lwd=3)
legend(45, 2000, legend=c("S","E","I","R"),
       col=c("blue", "orange1","red2","green3"), lty=1,lwd=2, cex=1.3)
